...
describe("AddToCart-Register-Delete User", { testIsolation: false }, () => {
  ...
  it("Verify product names and images", () => {
    cy.productNamesImages(testData);
  ...
  it("Verify Register / Login account to proceed on checkout", () => {
    cy.registerLoginToProceedCheckout();
    // cy.scrollTo('right');
  ...
  it("Verify successful check-out after registration", () => {
    cy.checkoutAfterRegistration();
